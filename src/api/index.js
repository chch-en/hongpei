...
export async function demo() {
  return await fetchData(
    '/v2/feed/getNew?_t=1595646711807&csrfToken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOjAsImV4cCI6MTc4NDY5MTA5NSwiaWF0IjoxNTk1Mzg4Njk1fQ.xWzeMlhWR79-9exqPtWY_34IcqtUIwGvEMAD52RMe2s&pageIndex=0&pageSize=10'
  )
}
...
export async function login(data) {
  return await fetchData1.post('/users/login.action', {
